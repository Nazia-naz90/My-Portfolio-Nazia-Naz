...
const About = () => {
  return (
   ...
   <div
    ...
    lg:w-[500px] w-[300px] h-[300px] container lg:ml-0 sm:ml-10 md:ml-52 
    px-5">
          <h1
        ...
        <div className="lg:w-[500px] lg:h-[full] w-[250px] h-[300px] lg:mb-32 lg:mt-0 mt-24 lg:mx-0 mx-auto">
          ...
          lg:w-[450px]
          lg:h-[full]
          rounded-xl shadow-2xl"></Image>
        </div>
      </div>
      {/* SKILLS & EXPERTIES */}
      <div className="flex flex-col  items-center
      gap-y-10 mt-0  mx-auto ">
          <h1 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[10vmin] text-center lg:mt-0 ">Skills and Experties </h1>
          {/* SKILL NO:01 */}
          <div className="flex flex-col items-center
          lg:border-4 border-2 border-purple-400 lg:w-[60%] w-[230px] lg:p-10  rounded-xl lg:h-[50%] h-[300px] lg:mr-40 p-5">
          <h2 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[7vmin] text-center">HTML & CSS</h2>
          <p className="text-white  lg:text-[20] lg:px-10 lg:font-bold
          lg:leading-10 lg:tracking-widest mt-5">
            The building blocks of the web. I love crafting clean, semantic HTML
            and beautiful, responsive CSS. These tools allow me to create
         ...
         {/* SKILL N0: 02 */}
         <div className="flex flex-col items-center
          lg:border-4 border-2 border-purple-400 lg:w-[60%] w-[230px] lg:p-10  rounded-xl lg:h-[50%] h-[430px] lg:ml-40 p-5">
            <h2 className="text-transparent bg-clip-text
          ...
          lg:leading-10 lg:tracking-widest mt-5">
            ...
            efficient.
                   ...
                   {/* SKILL N0: 03 */}
                   <div className="flex flex-col items-center
          lg:border-4 border-2 border-purple-400 lg:w-[60%] w-[230px] lg:p-10  rounded-xl lg:h-[50%] h-[350px] lg:mr-40 p-5">
            <h2 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[7vmin] text-center">
            Next.Js</h2>
          <p className="text-white  lg:text-[20] lg:px-10 p-3 lg:font-bold
      ...
      {/* SKILL N0: 04 */}
        <div className="flex flex-col items-center
          lg:border-4 border-2 border-purple-400 lg:w-[60%] w-[230px] lg:p-10  rounded-xl lg:h-[50%] h-[300px] lg:ml-40 p-5">
            <h2 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[10vmin] text-center">
            Tailwind CSS</h2>
          <p className="text-white  lg:text-[20] lgLpx-10 p-2 lg:font-bold
          lg:leading-10 lg:tracking-widest mt-5">
            Utility-first CSS has never been so fun! Tailwind allows me to
            design directly in my markup, speeding up development and ensuring consistency across my projects.
          </p>
          </div>
          
                   {/* SKILL N0: 05 */}
          <div className="flex flex-col items-center
          lg:border-4 border-2 border-purple-700 lg:w-[60%] w-[230px] lg:p-10  rounded-xl lg:h-[50%] h-[300px] lg:mr-40 p-5">
          <h2 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[7vmin] text-center">GITHUB</h2>
          <p className="text-white  lg:text-[20] lg:px-10 lg:font-bold
        ...
        <div className="flex flex-col items-center
         ...
         <div className="flex flex-col items-center justify-center
          lg:border-4 border-2 border-purple-400 lg:w-[60%] w-[230px] lg:p-10 
          p-5 rounded-xl lg:h-[50%] h-[100%] "> 
          <h2 className="text-transparent bg-clip-text
            bg-gradient-to-r from-purple-400 to-pink-600 text-[7vmin] text-center">My Philosophy</h2>
          <p className="text-white  lg:text-[20] lg:px-10 lg:font-bold
          lg:leading-10 lg:tracking-widest">
